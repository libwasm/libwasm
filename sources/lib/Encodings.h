...
inline const Opcode::Info Opcode::info[] =
{
    ...
    { Opcode::select, ImmediateType::select, SignatureCode::special, "select", 0 },
    { Opcode::selectV, ImmediateType::select, SignatureCode::special, "select", 0 },
    ...
    { Opcode::memory__size, ImmediateType::mem0, SignatureCode::i32_, "memory.size", 0 },
    { Opcode::memory__grow, ImmediateType::mem0, SignatureCode::i32__i32, "memory.grow", 0 },
